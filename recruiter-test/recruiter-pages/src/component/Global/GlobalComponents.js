...
export const NotificationIcon = (props) => {
  return (
    ...
    >
      <path
        d="M17.513 7.40398C17.513 5.70553 16.8171 4.07666 15.5783 2.87569C14.3396 1.6747 12.6596 1 10.9078 1C9.15597 1 7.47592 1.6747 6.2372 2.87569C4.99849 4.07666 4.30259 5.70553 4.30259 7.40398C4.30259 14.8753 1 17.0099 1 17.0099H20.8155C20.8155 17.0099 17.513 14.8753 17.513 7.40398Z"
        stroke={props.color}
        strokeWidth="1.5"
        strokeLinecap="round"
      ...
      />
      <path
        d="M12.8129 19.9998C12.6194 20.3041 12.3416 20.5566 12.0073 20.7321C11.6731 20.9076 11.2941 21 10.9084 21C10.5227 21 10.1437 20.9076 9.80952 20.7321C9.4753 20.5566 9.19744 20.3041 9.00391 19.9998"
        stroke={props.color}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const UserIcon = (props) => {
  return (
    ...
    >
      <path
        d="M9.75 29V27.25C9.75 22.4175 13.6675 18.5 18.5 18.5C23.3324 18.5 27.25 22.4175 27.25 27.25V29"
        stroke={props.color}
        strokeWidth="1.5"
        strokeLinecap="round"
      />
      <path
        d="M18.499 18.4998C21.3986 18.4998 23.749 16.1494 23.749 13.2498C23.749 10.3504 21.3986 7.99985 18.499 7.99985C15.5994 7.99985 13.249 10.3504 13.249 13.2498C13.249 16.1494 15.5994 18.4998 18.499 18.4998Z"
        stroke={props.color}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const VerticalSeparator = styled.div`
  ...
  @media screen and (max-width: 768px) {
    ${(props) => (props.separator ? "display:none" : "display: block;")}
  }
`;
...
export const CircleDoodle = () => {
  return (
    ...
    >
      <path
        d="M14.5603 73.1227C62.452 73.1227 118.203 80.8566 163.705 66.7718C187.657 59.3577 195.665 56.0147 195.665 33.4295C195.665 8.59568 118.766 3.26261 99.786 3.26261C75.164 3.26261 -9.33788 -2.46742 4.10436 39.604C6.88463 48.3056 25.572 65.6948 33.8939 69.9472C50.2729 78.3167 71.2156 79.3651 85.5817 89"
        stroke="#FA6EE1"
        strokeWidth="5"
        strokeLinecap="round"
      />
...
export const TiltedArrow = (props) => {
  return (
    ...
    >
      <path
        d="M33.7538 23.0736L30.8704 22.9884L31.203 12.9578L9.16549 33.6136L7.14498 31.4579L29.1825 10.8021L19.1436 10.4772L19.2528 7.6026L34.2388 8.08762L33.7538 23.0736Z"
        fill={props.color}
      />
    </svg>
  );
...
export const CheckBox = () => {
  return (
    ...
    >
      ...
      <path
        d="M14.3999 25.5624L19.5999 31.1094L32.5999 17.2419"
        stroke="white"
        strokeWidth="4"
        strokeLinecap="round"
        strokeLinejoin="round"
