...
import {
  CourseTitle,
  TextWrapper,
} from "../../../Course/Details/CourseElements";
...
const Hackathon = (data) => {
  ...
  useEffect(() => {
    api
      .get(`/instructor/${data.data.creator}`)
      .then((res) => {
        ...
        <div style={{ display: "flex", padding: "40px" }}>
              ...
              <Tabs.Panel value="questions" pl="lg">
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: renderQuestion(data.data.question),
                  }}
                ></div>
              </Tabs.Panel>
              ...
              <Tabs.Panel value="howto" pl="lg">
                <div style={{ padding: "0 30px", lineHeight: "2rem" }}>
                  ...
                  <ul style={{ listStyle: "numbers" }}>
                    <li>
                      Get familiar with the problem on the Problem Description
                      and About page.
                    </li>
                    <li>
                      Click the "Register" button on the banner to enroll in the
                      competition.
                    </li>
                    ...
                    <li>
                      ...
                      Submissions page and add a link to your approach.
                    </li>
                  </ul>
                </div>
              </Tabs.Panel>
          ...
          >
            ...
            {timeLeft === "Closed" ? (
              ...
              <P>ends:{new Date(data.data.endDate).toLocaleDateString()}</P>
            )}
            <div
              className="shadow"
              style={{
