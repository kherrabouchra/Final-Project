 ...
 console.log(schedule);
  ...
  return (
    ...
    <div style={{display:'flex' , background:'white', height:'600px', 
     backgroundColor:'#fafafa',flexDirection:"column", alignItems:"flex-end", margin:"0px 50px"}}>

      <SubHeader style={{padding:"0 80px", margin:"20px -30px 0 auto"}} >Schedule</SubHeader>
